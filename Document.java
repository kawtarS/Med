...
public abstract class Document {
	...
	public Document(int iSBN, String titre, String editeur, int annee,int nombreExemplaire) {
		super();
		ISBN = iSBN;
		this.titre = titre;
	...
	public Document(int iSBN, String titre, String editeur, int annee,int nombreExemplaire,String auteur1,String auteur2,String auteur3,String auteur4) {
		super();
		ISBN = iSBN;
		this.titre = titre;
		this.editeur = editeur;
