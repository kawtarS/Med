...
public class Magazine extends Document{
	...
	public Magazine(int iSBN, String titre, String editeur, int annee, int nombreExemplaire, int periode,
			String date_edit) {
	...
	public Magazine(int iSBN, String titre, String editeur, int annee, int nombreExemplaire) {
		super(iSBN, titre, editeur, annee, nombreExemplaire);
		// TODO Auto-generated constructor stub
	}
