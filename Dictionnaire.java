...
public class Dictionnaire extends Document {
	...
	public Dictionnaire(int iSBN, String titre, String editeur, int annee, int nombreExemplaire, String langue,
			String tome) {
	...
	public Dictionnaire(int iSBN, String titre, String editeur, int annee, int nombreExemplaire) {
		super(iSBN, titre, editeur, annee, nombreExemplaire);
		// TODO Auto-generated constructor stub
	}
